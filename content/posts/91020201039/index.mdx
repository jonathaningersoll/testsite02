...
This morning I woke up early to get a good start on our challenge which was to create a little page in HTML and then edit the CSS. The challenge itself increased in varying levels of difficulty, which was nice, and I did learn more about the precise difference between the \<thead> and the \<th> tag.
